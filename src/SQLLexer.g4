...
SECOND: S E C O N D;
YEAR: Y E A R;
EXCEPT_KW: E X C E P T;
EXPLAIN: E X P L A I N;
FILTER: F I L T E R;
GROUPING: G R O U P I N G;
HAVING_KW: H A V I N G;
...
// [bB]'value'
BIT_LITERAL: B SINGLE_QUOTE BITFrag+ SINGLE_QUOTE;
...
HEX_LITERAL: '0' X HEX_REP+ ( NEW_LINE_STRING+ HEX_REP+)*;
...
UNICODE_STRING_LITERAL:
	N SINGLE_QUOTE (ESCAPED_QUOTE | NEW_LINE_STRING | ~['\r\n])* SINGLE_QUOTE;
...
USER_VARIABLE: '@' [a-zA-Z_] VAR_SUFFIX*;
SYSTEM_VARIABLE: '@@' [a-zA-Z_] VAR_SUFFIX*;

fragment VAR_SUFFIX: [a-zA-Z0-9_#$];
